...
VS.ui.SearchFacet = Backbone.View.extend({
  ...
  // Sets the facet's code.model's value.
  set : function(value) {
    if (!value) return;
...
// The code.model that holds individual search facets and their categories.
